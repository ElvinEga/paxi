...
const OverlayCards = () => {
      ...
      entries.forEach((entry) => {
        ...
        if (cardIndex >= 0 && overlay && overlay.children[cardIndex]) {
          (overlay.children[cardIndex] as HTMLElement).style.width =
            `${width}px`;
          (overlay.children[cardIndex] as HTMLElement).style.height =
            `${height}px`;
        }
      });
    });
  ...
  return (
    <div>
      <div className='main flow  !mb-8 !p-0 !px-7'>
    ...
    <div className="blur"></div>
        ...
        <h2 className='main__heading text-gradient !mb-0 h-[40px]  px-7 !pb-0 text-left font-roboto text-2xl font-bold leading-[30px] sm:text-3xl sm:!leading-[2.5rem] md:h-[65px] md:text-center md:text-4xl md:!leading-[3rem] xl:text-5xl xl:!leading-[4rem]'>
          {t('prices')}
        </h2>
        ...
        <div className='main__cards cards' ref={cardsContainerRef}>
          <div className='cards__inner bg-tra'>
            ...
            >
              <h2 className='card__headin text-center text-black dark:text-white'>
                Бесплатно
              </h2>
              <p className='card__price text-center text-black dark:text-white'>
                $0
              </p>
              <ul
                role='list'
                className='card__bullets flow text-center text-black dark:text-white'
              >
              ...
              <a
                href='#basic'
                className='card__cta cta2 text-center !text-black !underline underline-offset-4 dark:!text-white'
              >
                Начать с этого
              </a>
            </div>
            ...
            >
              <h2 className='card__heading text-center text-black dark:text-white'>
                Про
              </h2>
              <p className='card__price text-center text-black dark:text-white'>
                $19.99
              ...
              <a
                href='#pro'
                className='card__cta cta2 !text-black !underline underline-offset-4 dark:!text-white'
              >
                Обновить до про
              </a>
            </div>
            ...
            >
              ...
              >
                ...
                <li>
                  Эсклюзвный доступ и раннее прилгашение к тестированию новых
                  функций
                </li>
              </ul>
              <a
