...
import { createIngress } from '@/app/[locale]/(protected)/stream/action';
...
export default function CreateIngressForm({
  ...
  return (
    <>
      {!ingress && (
        <div className='flex w-full flex-col justify-center space-y-6 border p-8 sm:w-[420px]'>
      ...
      {ingress && (
        <div className='mx-auto flex w-full flex-col justify-center space-y-4 border border-violet-500 p-8 sm:w-[420px]'>
          ...
          <div>
            ...
            <div className='rounded bg-violet-50 p-1 font-mono text-xs dark:bg-slate-800'>
              {ingress?.url}
            </div>
          </div>
          <div>
