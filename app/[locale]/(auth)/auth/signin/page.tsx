...
export default function SigninPage() {
  return (
    <section className='flex size-full flex-col items-center lg:flex-row'>
      <div className="flex h-0 max-h-screen w-full items-center justify-center bg-[url('/images/auth/signin-panel.svg')]  bg-auto bg-center bg-no-repeat lg:h-screen lg:w-1/2 xl:w-[60%]"></div>
